...
class Config:
    ...
    patchright_enabled: bool = False  # Use the Patchright standalone search service (local browser)
    patchright_base_url: str = "http://127.0.0.1:8931"  # Patchright search service base URL
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        patchright_enabled = parse_env_bool(
            os.getenv('PATCHRIGHT_ENABLED'),
            default=False,
        )
        patchright_base_url = os.getenv('PATCHRIGHT_BASE_URL', '').strip() or 'http://127.0.0.1:8931'
        ...
        return cls(
            ...
            patchright_enabled=patchright_enabled,
            patchright_base_url=patchright_base_url,
    ...
    def validate_structured(self) -> List[ConfigIssue]:
        ...
        if not self.has_search_capability_enabled():
            issues.append(ConfigIssue(
                severity="info",
                message="未配置搜索引擎能力 (Bocha/MiniMax/Tavily/Brave/SerpAPI/SearXNG/Patchright)，新闻搜索功能将不可用",
